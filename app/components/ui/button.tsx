    ...
    variants: {
      variant: {
        default:
          ...
          "bg-accent-purple text-primary-foreground shadow-xs hover:bg-accent-purple/90",
        destructive:
        ...
        secondary:
          ...
          "bg-background-tertiary text-white shadow-xs hover:bg-background-tertiary/80",
        ghost:
          // "hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50",
          "border-border-primary hover:bg-background-secondary hover:text-white dark:hover:bg-background-secondary/50",
